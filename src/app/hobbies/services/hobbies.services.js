...
var HobbiesServices = (function () {
    function HobbiesServices(http) {
        this.http = http;
        this.url = 'app/api/hobbies.json';
    }
    /********************************************************************************************************************/
    ...
    HobbiesServices.prototype.getHobbiesFromAPIWithCache = function () {
        var _this = this;
        if (this.data) {
    ...
    /********************************************************************************************************************/
    /********************************************************************************************************************/
    HobbiesServices.prototype.getHobbiesById = function (id) {
        if (!this.data) {
            return undefined;
        }
        var result = this.data.filter(function (hobbie) { return hobbie.id === id; });
        if (result.length > 0) {
            return result[0]; // recupère le premier élément du tableau
        }
    };
    return HobbiesServices;
}());
HobbiesServices = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], HobbiesServices);
exports.HobbiesServices = HobbiesServices;
//# sourceMappingURL=hobbies.services.js.map